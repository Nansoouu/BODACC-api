...
Puntos de entrada del sitio : mantenidos para robots y agentes.
Todas las URLs devuelven HTTP 200 y son de acceso público.

## Sitio (multilingüe : 20 idiomas, /es por defecto)

- Inicio: https://bodacc.io/es
- Anuncios: https://bodacc.io/es/annonces
- Empresas: https://bodacc.io/es/entreprises
- Personas: https://bodacc.io/es/personnes
- Actores (administradores judiciales): https://bodacc.io/es/acteurs
- Tarifas: https://bodacc.io/es/tarifs
- Tecnología / datos abiertos: https://bodacc.io/es/technologie
- Hub de regiones: https://bodacc.io/es/regions
- Ciudades: https://bodacc.io/es/villes
...
## Ejemplos (páginas de entidades)

- Example company page (es): https://bodacc.io/es/entreprises/514494491
- Example notice page (es): https://bodacc.io/es/annonces/A202601511039
