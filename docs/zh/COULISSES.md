...
→ [了解邮递员的工作](coulisses/le-facteur/README.md)

## 📖 接着：翻译员

官方公告是用行政语言写成的文本，并不总是容易阅读。我们的**翻译员**会通读它们，并将其转化为清晰的档案：公司名称、地址、业务、高管、金额……

→ [了解翻译员的工作](coulisses/le-traducteur/README.md)
