# BODACC.io : elenco URL

> 🌍 [Français](../fr/URLLIST.md) · [Español](../es/URLLIST.md) · [Deutsch](../de/URLLIST.md) · [Italiano](URLLIST.md) · [Português](../pt/URLLIST.md) · [Nederlands](../nl/URLLIST.md) · [Polski](../pl/URLLIST.md) · [Русский](../ru/URLLIST.md) · [Türkçe](../tr/URLLIST.md) · [Українська](../uk/URLLIST.md) · [Bahasa Indonesia](../id/URLLIST.md) · [Tiếng Việt](../vi/URLLIST.md) · [日本語](../ja/URLLIST.md) · [한국어](../ko/URLLIST.md) · [中文](../zh/URLLIST.md) · [العربية](../ar/URLLIST.md) · [עברית](../he/URLLIST.md) · [हिन्दी](../hi/URLLIST.md) · [فارسی](../fa/URLLIST.md) · [English](../en/URLLIST.md)
Punti di ingresso del sito : mantenuti per crawler, bot e agenti.
Tutti gli URL seguenti restituiscono HTTP 200 e sono pubblicamente accessibili.

## Sito (multilingue : 20 lingue, /it predefinito)

- Home: https://bodacc.io/it
- Annunci: https://bodacc.io/it/annonces
- Aziende: https://bodacc.io/it/entreprises
- Persone: https://bodacc.io/it/personnes
- Attori (curatori fallimentari): https://bodacc.io/it/acteurs
- Tariffe: https://bodacc.io/it/tarifs
- Tecnologia / open data: https://bodacc.io/it/technologie
- Hub regioni: https://bodacc.io/it/regions
- Città: https://bodacc.io/it/villes
...
## Esempi (pagine di entità)

- Example company page (it): https://bodacc.io/it/entreprises/514494491
- Example notice page (it): https://bodacc.io/it/annonces/A202601511039
